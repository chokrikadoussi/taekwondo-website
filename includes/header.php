...
<header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
        <a href="index.php" class="flex items-center" aria-label="Aller à l’accueil">
            <img src="img/logo.png" alt="Logo Taekwondo Club" class="h-10 w-auto mr-2">
            <span class="text-xl font-semibold">Taekwondo Club</span>
        </a>
        <nav aria-label="Menu principal">
            <ul class="flex space-x-6">
                ...
                <li><a href="classes.php" class="hover:text-accent">Cours</a></li>
